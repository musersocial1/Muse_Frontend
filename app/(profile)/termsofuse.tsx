...
export default function TermsOfUse() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#121212]">
      ...
      >
        {/* Last Updated */}
        <Text className="text-white text-[16px] font-medium mt-6 mb-2">
          Last Updated: 01/04/2025 02:43pm
        </Text>

        {/* Introduction */}
        <Text className="text-white text-[16px] font-medium mb-8 leading-6">
          Welcome to muse By using our platform, you agree to the following
          terms. Please read them carefully.
        </Text>

        {/* Section 1 */}
        <Text className="text-gray-400 text-[16px] font-medium mb-4">
          1. Acceptance of Terms
        </Text>

        <Text className="text-gray-400 text-[16px] mb-8 leading-6">
        ...
        <View className="mb-8">
          <View className="flex-row items-start mb-3">
            <Text className="text-gray-400 text-[16px] mr-2">•</Text>
            <Text className="text-gray-400 text-[16px] flex-1 leading-6">
          ...
          <View className="flex-row items-start">
            <Text className="text-gray-400 text-[16px] mr-2">•</Text>
            <Text className="text-gray-400 text-[16px] flex-1 leading-6"></Text>
          </View>
        </View>
        ...
        <Text className="text-gray-400 text-[16px] mb-4 leading-6">
        ...
        <View className="mb-6">
          <View className="flex-row items-start mb-3">
            ...
            <Text className="text-white text-[16px] flex-1 leading-6">
        ...
        <Text className="text-gray-400 text-[16px] leading-6">
